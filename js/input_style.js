...
function add_row(count){
    ...
    for(var j=0;j<19;j++){
        ...
        if(j!=0 & j!=11){
            ...
            btns[i][j].id = 'num[' + i + '][' + j + ']';
            btns[i][j].setAttribute('placeholder', '0');
            
            //数値以外の入力を拒否
            btns[i][j].addEventListener('input', function(event) {
                var value = event.target.value;
                if (isNaN(value)) { // 入力が数値でない場合
                    event.target.value = ''; // 値を空にするか、適切な処理を行う
                }
            });
            if(j == 12){
                btns[i][j].setAttribute('placeholder', 'ここは自動で計算するよ')
...
//get value as number
function get(i,j){
    var Input = document.getElementById('num[' + i + '][' + j + ']');
                ...
                switch(j){
                    ...
                    case 5:
                        if(get(i,1)==0){
                            ...
                            new_row.push(financial((get(i,2)+get(i,3))/get(i,1)*100));
                        }
                        break;
                    case 6:
                        if(get(i,1)==0){
                            ...
                            new_row.push(financial(get(i,4)/get(i,1)*100));
                        }
                        break;
                    case 7:
                    case 8:
                    ...
                    case 13:
                        if(get(i,5)==0){
                            ...
                            new_row.push(financial(get(i,6)/get(i,5)*100));
                        }
                        break;
                    case 14:
                        if(get(i,5)==0){
                            ...
                            new_row.push(financial(get(i,7)/get(i,5)*100));
                        }
                        break;
                    case 16:
                        new_row.push(get(i,13)+get(i,14)+get(i,15)+get(i,16));
                        break;
                    case 17:
                    case 18:
                    case 19:
                    case 20:
                        new_row.push(get(i,j-4));
                        break;
                    case 21:
                        if(new_row[16]==0){
                            new_row.push('/');
                            ...
                            new_row.push(financial((get(i,13)+get(i,14)*0.7+get(i,15)*0.3)/new_row[16]*100));
                        }
                        break;
                    case 22:
                    case 23:
                        new_row.push(get(i,j-5)); 
                        break;               
                }
            }
